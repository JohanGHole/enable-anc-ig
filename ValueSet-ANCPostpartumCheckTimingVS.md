# ANC - postpartum check timing value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ANC - postpartum check timing value set**

## ValueSet: ANC - postpartum check timing value set 

| | |
| :--- | :--- |
| *Official URL*:https://hispethiopia.org/enable/ValueSet/ANCPostpartumCheckTimingVS | *Version*:0.1.0 |
| Active as of 2026-01-15 | *Computable Name*:ANCPostpartumCheckTimingVS |
