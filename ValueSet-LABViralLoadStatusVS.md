# LAB Viral load status value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **LAB Viral load status value set**

## ValueSet: LAB Viral load status value set 

| | |
| :--- | :--- |
| *Official URL*:https://hispethiopia.org/enable/ValueSet/LABViralLoadStatusVS | *Version*:0.1.0 |
| Active as of 2026-01-15 | *Computable Name*:LABViralLoadStatusVS |
