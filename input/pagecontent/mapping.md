...
| FHIR path (what you send) | DHIS2 code | Bahmni source | PulseTech key |
|---|---|---|---|
...
| `Organization.name` | (none) | Facility display name | Facility display name |
...
See [Mapping Script Recipes](mapping-scripts.html) for JSONata / DataSonnet / Python / jq recipes.
