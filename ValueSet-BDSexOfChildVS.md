# BD-Sex of child value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **BD-Sex of child value set**

## ValueSet: BD-Sex of child value set 

| | |
| :--- | :--- |
| *Official URL*:https://hispethiopia.org/enable/ValueSet/BDSexOfChildVS | *Version*:0.1.0 |
| Active as of 2026-01-15 | *Computable Name*:BDSexOfChildVS |
