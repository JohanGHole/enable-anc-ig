# ANC MUAC color code value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ANC MUAC color code value set**

## ValueSet: ANC MUAC color code value set 

| | |
| :--- | :--- |
| *Official URL*:https://hispethiopia.org/enable/ValueSet/ANCMUACColorCodeVS | *Version*:0.1.0 |
| Active as of 2026-01-15 | *Computable Name*:ANCMUACColorCodeVS |
