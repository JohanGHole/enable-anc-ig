...
* Paste the output into [https://validator.fhir.org/](https://validator.fhir.org/) and validate. See the [Quickstart, step 3](quickstart.md#3-validate) for the exact fields (IG package URL + Bundle profile canonical).
