# Vital status of child value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Vital status of child value set**

## ValueSet: Vital status of child value set 

| | |
| :--- | :--- |
| *Official URL*:https://hispethiopia.org/enable/ValueSet/VitalStatusOfChildVS | *Version*:0.1.0 |
| Active as of 2026-01-15 | *Computable Name*:VitalStatusOfChildVS |
