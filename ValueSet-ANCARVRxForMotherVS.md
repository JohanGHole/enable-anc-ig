# ANC ARV Rx for Mother value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **ANC ARV Rx for Mother value set**

## ValueSet: ANC ARV Rx for Mother value set 

| | |
| :--- | :--- |
| *Official URL*:https://hispethiopia.org/enable/ValueSet/ANCARVRxForMotherVS | *Version*:0.1.0 |
| Active as of 2026-01-15 | *Computable Name*:ANCARVRxForMotherVS |
