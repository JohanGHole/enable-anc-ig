# Partner HIV test result value set - v0.1.0

* [**Table of Contents**](toc.md)
* [**Artifacts Summary**](artifacts.md)
* **Partner HIV test result value set**

## ValueSet: Partner HIV test result value set 

| | |
| :--- | :--- |
| *Official URL*:https://hispethiopia.org/enable/ValueSet/PartnerHIVTestResultVS | *Version*:0.1.0 |
| Active as of 2026-01-15 | *Computable Name*:PartnerHIVTestResultVS |
